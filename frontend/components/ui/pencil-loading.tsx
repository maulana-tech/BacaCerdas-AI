...
/**
 * Shout out to the original creator of this animation: https://uiverse.io/gustavofusco/rare-pug-90
 * @returns 
 */
export default function PencilLoading() {
    return (<svg xmlns="http://www.w3.org/2000/svg" height="200px" width="200px" viewBox="0 0 200 200" className="pencil">
        <defs>
